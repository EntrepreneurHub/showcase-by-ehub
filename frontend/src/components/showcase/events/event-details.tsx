...
const EventDetails: React.FC<{ eventId: number }> = ({ eventId }) => { // eslint-disable-line @typescript-eslint/no-unused-vars
  // TODO: Replace with actual API call using eventId
