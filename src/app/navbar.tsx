  ...
  return (
    <nav className="flex flex-col md:flex-row justify-between items-center bg-[#D9D9D9] p-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-4">
        ...
        <Link href="/ProjectDirectory" className="text-black hover:text-gray-600">See Our Projects</Link>
        <Link href="/SignIn" className="text-black hover:text-gray-600">Login In</Link>
      </div>
    </nav>
  );
};
